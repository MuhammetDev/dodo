...
module.exports = {
  ...
  async execute(client, message, args) {
    ...
    const kayitsizRoleID = '1264249388516249631';
    const kizRoleID = '1263218335361929256';
    const erkekRoleID = '1264249044071612500';
    const logChannelID = '1242942289211560039';
    const yetkiliRoleID = '1264252101937070242';
